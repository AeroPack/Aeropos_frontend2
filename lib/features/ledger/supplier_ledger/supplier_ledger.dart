...
class _SupplierLedgerScreenState extends State<SupplierLedgerScreen> {
  ...
  Future<void> _exportToPdf() async {
    ...
    final fileName =
        'supplier_ledger_${DateTime.now().millisecondsSinceEpoch}.pdf';
      ...
      children: [
        ...
        Row(
          children: [
            ...
            ElevatedButton.icon(
              onPressed: () => context.push('/supplier-ledger/add'),
    ...
    return Container(
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<int?>(
          value: _viewModel.selectedSupplierId,
          isExpanded: true,
          hint: Text(
            'All Suppliers',
...
class SupplierLedgerDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: Text('Supplier Ledger Detail - Coming Soon')),
    );
  }
}
